<?php 
  session_start();
   ...
   if(!isset($_SESSION["login_ldr"]) || $_SESSION['level_ptg']!="kasir"){
    echo "<script>alert('Anda Bukan Kasir')</script>";
  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <ul class="sidebar navbar-nav" style="margin-top: 56px;">
        ...
        <li class="nav-item">
          <a class="nav-link" href="kasir.php?p=home">
        ...
        <li class="nav-item">
          <a class="nav-link" href="kasir.php?p=order">
            <i class="fas fa-fw fa-table"></i>
            <span>Cucian Masuk</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="kasir.php?p=transaksi">
            <i class="fas fa-fw fa-shopping-cart"></i>
            <span>Transaksi</span></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="kasir.php?p=ganti_password">
      ...
      <div id="content-wrapper" style="margin-top:56px;">
        ...
        <?php 
          if( empty($_GET['p']) ){
            echo "<script>document.location.href='kasir.php?p=home'</script>";
          }else{
            $p=$_GET['p'];
            include "content_k/$p.php";
          }
         ?>
